...
export type FilmWithVariablesQueryDocumentQueryVariables = Exact<{
  id?: InputMaybe<Scalars["ID"]["input"]>;
}>;

export type FilmWithVariablesQueryDocumentQuery = {
  __typename?: "Root";
  film?:
    | ({ __typename?: "Film" } & {
...
export const FilmWithVariablesQueryDocumentDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "filmWithVariablesQueryDocument" },
      variableDefinitions: [
        {
  ...
  FilmWithVariablesQueryDocumentQuery,
  FilmWithVariablesQueryDocumentQueryVariables
>;
